...
int main(void)
{
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        if (CheckCollisionPointRec(mousePosition, (RL_Rectangle){ rec.x + rec.width - MOUSE_SCALE_MARK_SIZE, rec.y + rec.height - MOUSE_SCALE_MARK_SIZE, MOUSE_SCALE_MARK_SIZE, MOUSE_SCALE_MARK_SIZE }))
        {
        ...
        BeginDrawing();
            ...
            RL_DrawText("Scale rectangle dragging from bottom-right corner!", 10, 10, 20, GRAY);
