...
int main(void)
{
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            RL_DrawText("CHECKED TEXTURE ", 84, 85, 30, BROWN);
            RL_DrawText("GENERATED by CODE", 72, 148, 30, BROWN);
            RL_DrawText("and RAW IMAGE LOADING", 46, 210, 30, BROWN);

            RL_DrawText("(c) Fudesumi sprite by Eiden Marsal", 310, screenHeight - 20, 10, BROWN);
