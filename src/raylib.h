...
RLAPI void DrawRectangleGradientEx(RL_Rectangle rec, Color topLeft, Color bottomLeft, Color bottomRight, Color topRight); // Draw a gradient-filled rectangle with custom vertex colors
...
RLAPI Image RL_LoadImage(const char *fileName);                                                             // Load image from file into CPU memory (RAM)
...
RLAPI void UpdateTextureRec(Texture2D texture, RL_Rectangle rec, const void *pixels);                       // Update GPU texture rectangle with new data (pixels and rec should fit in texture)
...
RLAPI void RL_DrawText(const char *text, int posX, int posY, int fontSize, Color color);       // Draw text (using default font)
RLAPI void RL_DrawTextEx(Font font, const char *text, Vector2 position, float fontSize, float spacing, Color tint); // Draw text using font and additional parameters
...
RLAPI void RL_PlaySound(Sound sound);                                    // Play a sound
